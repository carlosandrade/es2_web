...
class LAdministrador:
    ...
    def aceitaOferta(self,nomeOferta):
        ...
        print "Content-type:text/html\r\n\r\n"
        print "<meta HTTP-EQUIV=\"Refresh\" CONTENT=\"0;URL=/cgi-bin/TAvaliarOferta.py?update=exibeOfertaAceita\">"  
    ...
    def recusaOferta(self,nomeOferta):
        ...
        mOferta.saveAll(ofertas)
        print "Content-type:text/html\r\n\r\n"
        print "<meta HTTP-EQUIV=\"Refresh\" CONTENT=\"0;URL=/cgi-bin/TAvaliarOferta.py?update=exibeOfertaRecusada\">"    
    ...
    def diaOferta(self,nomeOferta):
        ...
        mOferta.saveAll(ofertas)
        print "Content-type:text/html\r\n\r\n"
        print "<meta HTTP-EQUIV=\"Refresh\" CONTENT=\"0;URL=/cgi-bin/TAvaliarOferta.py?update=exibeDiaOferta\">" 
